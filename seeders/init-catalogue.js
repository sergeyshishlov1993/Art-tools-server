...
module.exports = {
    async up(queryInterface) {
        ...
        await queryInterface.bulkInsert('sub_category', [
            ...
            { sub_category_id: 'akumulyatorni-pylky', sub_category_name: 'Акумуляторні пилки', parent_id: 'accum-tool' },
            { sub_category_id: 'ak-pyla-dyskova', sub_category_name: 'Акумуляторні дискові пили', parent_id: 'accum-tool' },
            { sub_category_id: 'ak-pyla-shabelna', sub_category_name: 'Акумуляторні шабельні пили', parent_id: 'accum-tool' },
            { sub_category_id: 'ak-lobzyk', sub_category_name: 'Акумуляторні лобзики', parent_id: 'accum-tool' },
            ...
            { sub_category_id: 'ak-gazonokosarka', sub_category_name: 'Акумуляторні газонокосарки', parent_id: 'accum-tool' },
            { sub_category_id: 'ak-kushchoriz', sub_category_name: 'Акумуляторні кущорізи та садові ножиці', parent_id: 'accum-tool' },
            { sub_category_id: 'ak-opryskuvach', sub_category_name: 'Акумуляторні обприскувачі', parent_id: 'accum-tool' },
            { sub_category_id: 'ak-pylosos', sub_category_name: 'Акумуляторні пилососи', parent_id: 'accum-tool' },
            { sub_category_id: 'ak-povitroduvka', sub_category_name: 'Акумуляторні повітродувки', parent_id: 'accum-tool' },
            { sub_category_id: 'ak-trymer', sub_category_name: 'Акумуляторні тримери та коси', parent_id: 'accum-tool' },
            ...
            { sub_category_id: 'ak-fen', sub_category_name: 'Акумуляторні будівельні фени', parent_id: 'accum-tool' },
            { sub_category_id: 'ak-prysoska', sub_category_name: 'Акумуляторні вакуумні та вібраційні присоски', parent_id: 'accum-tool' },
            { sub_category_id: 'ak-poliruvalna', sub_category_name: 'Акумуляторні полірувальні машини', parent_id: 'accum-tool' },
            ...
            { sub_category_id: 'electro-tool-kutoshlifuvalni-mashyny', sub_category_name: 'Кутошліфувальні машини', parent_id: 'electro-tool' },
