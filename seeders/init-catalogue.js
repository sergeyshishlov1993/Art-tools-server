...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        await queryInterface.bulkInsert('category', [
            { id: 'accum-tool', category_name: 'Акумуляторний інструмент' },
            { id: 'electro-tool', category_name: 'Електроінструмент' },
            { id: 'verstaty', category_name: 'Верстати та Обладнання' },
            { id: 'zvaryuvannya', category_name: 'Зварювальне обладнання' },
            { id: 'sad-gorod', category_name: 'Садова техніка' },
            { id: 'budivnytstvo', category_name: 'Будівельне обладнання' },
            { id: 'avto-rashodnik', category_name: 'Автотовар та Витратники' }
        ], {});
